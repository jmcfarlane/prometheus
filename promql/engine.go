...
var (
	...
	maxConcurrentQueries = flag.Int("query.max-concurrent", 20, "Maximum number of queries executed concurrently.")
)
...
// newQueryGate returns a query gate that limits the amount of queries
